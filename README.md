...
<div align="center">
  ...
  <h3><b>Bookstore with React and Redux</b></h3>
...
```sh
  git clone https://github.com/AmanWorku/Bookstore.git
  cd Math-magician
```
...
To intall dependencies, execute the following command:
...
Feel free to check the [issues page](https://github.com/AmanWorku/Bookstore/issues).
